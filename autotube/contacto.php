...
<!-- Mirrored from www.autotube.cl/web/contacto.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Sep 2014 16:33:06 GMT -->
<head>
...
<div id="top" class="container_24">
  ...
  <div id="boton_publicar" class="grid_7">
          ...
          <div id="contacto">
            ...
            <h2>Consulta</h2>
            				<table width="650" border="0" align="center" cellpadding="5" id="contacto">
  <tr>
    <th width="224" scope="row">Nombre Completo*</th>
    <th width="246" scope="row"><label for="nombre"></label>
  ...
  <tr>
    <th scope="row">Deje su mensaje</th>
    <th scope="row"><label for="mensaje"></label>
  ...
  <tr>
    <th scope="row">&nbsp;</th>
    <th scope="row"><input type="submit" name="Enviar" id="Enviar" value="Realizar Consulta" /></th>
  </tr>
</table>
            </form>
           	</div>	
...
<!-- Mirrored from www.autotube.cl/web/contacto.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Sep 2014 16:33:07 GMT -->
</html>
...
<td class="contrato">Número Representante</td><td class="contrato"><input class="entrada" type="text" name="numero_representante" value="<?php echo @$_POST[numero_representante]; ?>"></td>
...
<td class="contrato">Número Contratado</td><td class="contrato"><input class="entrada" type="text" name="numero_contratado" value="<?php echo @$_POST[numero_contratado]; ?>"></td>
...
<td class="contrato">Unidades Mínimas</td><td class="contrato"><input class="entrada" type="text" name="unidades_minimas" value="<?php echo @$_POST[unidades_minimas]; ?>"></td>
</tr>
<tr>
...
<td class="contrato">Fecha Término</td><td class="contrato"><input class="entrada" type="text" name="fecha_termino" value="<?php echo @$_POST[fecha_termino]; ?>"></td>
...
<td class="contrato">Período Pago</td><td class="contrato"><input class="entrada" type="text" name="periodo_pago" value="<?php echo @$_POST[periodo_pago]; ?>"></td>
...
<td class="contrato">Duración</td><td class="contrato"><input class="entrada" type="text" name="duracion" value="<?php echo @$_POST[duracion]; ?>"></td>
